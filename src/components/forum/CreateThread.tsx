...
// Huvudkomponent - wrapper utan useSearchParams
      ...
      <form onSubmit={handleSubmit} className="bg-white rounded-lg shadow-sm p-6">
        ...
        <div className="mb-4">
          ...
          <TiptapEditor 
            content={content} 
            onChange={setContent}
            placeholder="Beskriv din fråga eller ämne..."
          />
        ...
        <div className="flex items-center justify-end mt-6 space-x-3">
          ...
          <button 
            type="submit" 
            className="px-4 py-2 bg-pink-600 text-white rounded-md hover:bg-pink-700 focus:outline-none focus:ring-2 focus:ring-pink-500 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed flex items-center"
            disabled={loading}
          >
            {loading ? (
              <>
